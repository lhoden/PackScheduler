...
public class CourseNameValidatorTest {
	...
	public void testGetLetterCount(){
		try {
			cn.isValid("CSC216");
			assertEquals(3, cn.getLetterCount());
	...
	/**
	 * Tests get digitCount
	 */
	@Test
	public void testGetDigitCount() {
		try {
			cn.isValid("CSC216");
			assertEquals(3, cn.getDigitCount());
		} catch (InvalidTransitionException e) {
			fail();
		}
	}
	...
	public void testIsValidStateInitial() {
		try {
			...
			assertEquals(e.getMessage(), "Course must start with a letter");
		}
	}
